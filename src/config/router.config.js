...
export const asyncRouterMap = [
  {
    ...
    children: [
      // 组态
      {
        path: '/configgraphic',
        name: 'configgraphic',
        redirect: '/configgraphic/configtool',
        component: RouteView,
        meta: { title: '组态', keepAlive: true, icon: 'diff', permission: ['configgraphic'] },
        children: [
          {
            path: '/configgraphic/configtool',
            name: 'Configtool',
            component: () => import('@/views/configgraphic/Configtool'),
            meta: { title: '组态工具', keepAlive: false, permission: ['configgraphic'] }
          }
        ]
      },
      ...
      // dashboard
      {
        ...
        redirect: '/dashboard/Analysis',
        component: RouteView,
        meta: { title: '综合监控', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'] },
        children: [{
        ...
        // 外部链接
        {
          ...
          name: 'Monitor',
          meta: { title: '三方系统（外部）', target: '_blank' }
        },
        {
        ...
        },
        {
          ...
          name: 'TestWork',
          component: () =>
                        import('@/views/dashboard/TestWork'),
          meta: { title: '电子地图', keepAlive: true, permission: ['dashboard'] }
        }
        ]
      },
      // list
      {
        ...
        meta: { title: '告警管理', icon: 'table', permission: ['table'] },
        children: [{
          ...
          meta: { title: '活动告警', keepAlive: true, permission: ['table'] }
        },
        {
          ...
          meta: { title: '告警屏蔽', keepAlive: true, permission: ['table'] }
        },
        {
          path: '/list/card',
          name: 'CardList',
          ...
          meta: { title: '告警通知', keepAlive: true, permission: ['table'] }
        },
        {
          path: '/list/search',
          name: 'SearchList',
      ...
      // forms
      {
        ...
        component: PageView,
        meta: { title: '报表', icon: 'form', permission: ['form'] },
        children: [{
          path: '/form/base-form',
          name: 'BaseForm',
          component: () =>
      ...
      // profile
      {
        ...
        meta: { title: '运维', icon: 'profile', permission: ['profile'] },
        children: [{
          path: '/profile/basic',
          name: 'ProfileBasic',
          component: () =>
                        import('@/views/profile/basic/Index'),
          meta: { title: '实时数据巡检', permission: ['profile'] }
        },
        {
          ...
          meta: { title: '设备维护计划', permission: ['profile'] }
        }
        ]
      },
      ...
      // result
      {
        ...
        meta: { title: '运营', icon: 'check-circle-o', permission: ['result'] },
        children: [{
          path: '/result/success',
          name: 'ResultSuccess',
          component: () =>
                        import( /* webpackChunkName: "result" */ '@/views/result/Success'),
          meta: { title: '能耗管理', keepAlive: false, hiddenHeaderContent: true, permission: ['result'] }
        },
        {
          path: '/result/fail',
          name: 'ResultFail',
          ...
          meta: { title: '容量管理', keepAlive: false, hiddenHeaderContent: true, permission: ['result'] }
        }
        ]
      },
